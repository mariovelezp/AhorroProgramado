...
{
    public class prvSegmentoGralRequest
    {
        ...
        public DataSet MiMetaBG_consGral_Segmento(int Id, ref string CodError, ref string Descripcion)
        {
